                    ...
                    <table class="table mb-0" id="orderTable">
                        ...
                        <tbody class="ligth-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="flex justify-center items-center text-brick hover:text-lgreen text-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('orders.edit', $order->id) }}">
                                        {{ $order->order_number }}
                                    </a>
                                </td>
                                ...
                                <td class="print:hidden">
                                    <div class="flex gap-2 text-xl">
                                        ...
                                        <form action="{{ route('orders.destroy', $order->id) }}" method="POST" style="margin-bottom: 5px">
                                            @method('delete')
                                            @csrf
                                            <button type="submit" class="bg-red-500 p-2 rounded-sm text-sm flex justify-center items-center text-white" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="ri-delete-bin-line mr-0"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
